...
//<VHWarmInfoObjectDelegate, WKUIDelegate, WKNavigationDelegate, UIScrollViewDelegate>
@interface JMKWarmUpViewController ()
...
@implementation JMKWarmUpViewController
...
- (void)requestWebinarInfoData
{
    ...
    [VHWebinarInfoData requestWatchInitWebinarId:self.webinarId
        ...
        if (webinarInfoData) {
            ...
            // 标题
            weakSelf.title = [JMKUITool substringToIndex:8
            ...
            // 昵称
            weakSelf.nicknameLab.text = [JMKUITool substringToIndex:8
            ...
            // 活动标题
            weakSelf.webinarTitleLab.text = [JMKUITool substringToIndex:8
                                                                 text:webinarInfoData.webinar.subject
                                                          isReplenish:YES];
            ...
            // 空空如也
//            weakSelf.emptyView.hidden = !([JMKUITool isBlankString:webinarInfoData.webinar.introduction] || [webinarInfoData.webinar.introduction isEqualToString:@"<p></p>"]);
            
            weakSelf.webView.hidden = ([JMKUITool isBlankString:webinarInfoData.webinar.introduction] || [webinarInfoData.webinar.introduction isEqualToString:@"<p></p>"]);
...
- (void)startWithPlayer
{
    if (self.warmInfoModel.record_list.count > 0) {
        ...
        [JMKProgressHud showToast:@"无暖场视频"];
    }
}
...
- (void)statusDidChange:(VHPlayerState)state
{
    switch (state) {
        ...
        case VHPlayerStateStarting:{
            ...
            [JMKProgressHud showLoading:@"正在加载" inView:self.warmVod];
        }
        break;
        ...
        case VHPlayerStatePlaying:{
            ...
            [JMKProgressHud hideLoadingInView:self.warmVod];
        }
        break;
...
- (UILabel *)subscribeLab {
    if (!_subscribeLab) {
        ...
        _subscribeLab.textColor = JMKMainColor;
