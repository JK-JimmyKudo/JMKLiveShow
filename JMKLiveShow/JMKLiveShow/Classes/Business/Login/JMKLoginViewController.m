...
@interface JMKLoginViewController ()<UIAlertViewDelegate>
...
@implementation JMKLoginViewController
...
//
//    self.thirdIdTextField.text = [JMKUITool isBlankString:DEMO_Setting.third_Id] ? @"66" : DEMO_Setting.third_Id;
