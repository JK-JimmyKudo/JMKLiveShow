...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        // 下载按钮
        CGFloat btnW = 50.f;
        HWDownloadButton *downloadBtn = [[HWDownloadButton alloc] initWithFrame:CGRectMake(backView.width - btnW - margin, (backViewH - btnW) * 0.5, btnW, btnW)];
        ...
        // 文件大小标签
        UILabel *fileSizeLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(speedLable.frame), CGRectGetMaxY(titleLabel.frame), titleLabel.frameWidth - speedLable.width, backViewH * 0.4)];
